package com.aayush.resilence4j.retry;
...
import com.aayush.resilence4j.model.*;
import com.aayush.resilence4j.services.FlightBookingService;
import com.aayush.resilence4j.services.FlightSearchService;
import com.aayush.resilence4j.services.failures.FailHalfTheTime;
import com.aayush.resilence4j.services.failures.FailNTimes;
import com.aayush.resilence4j.services.failures.RateLimitFailNTimes;
...
public class RetryExamples {
  ...
  void retryExceptionsIgnoreExceptionsExample() {
    RetryConfig config = RetryConfig.custom().
      ...
      retryExceptions(FlightServiceException.class).
  ...
  public void retryInit() {
    ...
    basicExample_ServiceThrowingException_v1();
    System.out.println("----------------------------------------------------------------------");

    System.out.println("-------------------------- basicExample_ServiceThrowingException_v2 --------------------------------------------");
    basicExample_ServiceThrowingException_v2();
    System.out.println("----------------------------------------------------------------------");
    ...
    retryExceptionsIgnoreExceptionsExample();
    System.out.println("----------------------------------------------------------------------");
